...
const title = '三步走战略，加速企业向数智化转变'
</script>

<template>
  <div flex="~ col" items-center class="section-box" h-840px>
    <h1>{{ title }}</h1>
